...
urlpatterns = [
    ...
    path('pupils/report/download/<str:pk>', views.downloadPdf, name='download_pdf'),
    ...
    path('tests/test1/answers/<str:pk>', views.Test1Answers, name='test1_answers'),
    ...
    path('schools/delete/<str:pk>', views.deleteSchool, name='delete_school'),
    path('schools/edit/<str:pk>', views.editSchool, name='edit_school'),
    path('schools/create/', views.createSchool, name='create_school'),
    path('classrooms/delete/<str:pk>', views.deleteClassroom, name='delete_school'),
    path('classrooms/edit/<str:pk>', views.editClassroom, name='edit_school'),
    path('classrooms/create/<str:pk>', views.createClassroom, name='create_school'),
